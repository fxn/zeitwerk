...
class TestUnregister < LoaderTest
  test "unregister removes the loader from internal state" do
    ...
    registry.namespaces.register(cref1, loader1)
    ...
    registry.namespaces.register(cref2, loader2)
    ...
    assert !registry.namespaces.registered?(cref1)
    ...
    assert registry.namespaces.registered?(cref2) == loader2
  end
